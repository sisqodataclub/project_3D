...
const Hero = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden bg-[#050816]">
      ...
      {/* Main Content */}
      <div className="relative z-10 w-full h-full flex justify-center items-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <IntroCard />
      </div>

      {/* Scroll Indicator - Modernized */}
      <div className="absolute xs:bottom-10 bottom-12 w-full flex justify-center items-center z-20">
